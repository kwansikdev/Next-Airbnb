      ...
      <ul className='home-category-card-list'>
        <li>
          <div className='home-category-card-image-wrapper'>
            <img src='/static/image/home/home_card_image_1.jpg' alt='가까운 여행지' />
          </div>
        ...
        <li>
          <div className='home-category-card-image-wrapper'>
            <img src='/static/image/home/home_card_image_2.jpg' alt='독특한 공간' />
          </div>
          <div className='home-category-card-texts'>
            <p className='home-category-card-title'>독특한 공간</p>
            <p className='home-category-card-description'>단순한 숙소 이상의 특별함이 담긴 공간</p>
          </div>
        </li>
        <li>
          <div className='home-category-card-image-wrapper'>
